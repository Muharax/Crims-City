...
<body>
			...
			<div class="navbar">
				<div id="container">
						...
						<a href="?link=nagrody">
							<div class="navbar-li">Nagrody</div>
							</a>
						<a href="?link=faq">
							<div class="navbar-li">F A Q</div>
							</a>
						<a href="?link=szukaj">
						...
						<a href="logout.php">
							<div class="navbar-li wyloguj">Wyloguj</div>
							</a>
							
							<div id="respekt">
							<div class="respekt-nazwa"><span class="span-green">Respekt: </span></div>
							<div class="respekt-punkty"><?php echo $respekt;?></div>
							
							</div>
							
							<div id="money">
							<div class="respekt-nazwa"><span class="span-green">Money: </span></div>
							<div class="respekt-punkty"><?php echo $money;?> $</div>
...
<div class="container">
	...
	<div class="menu">
		...
		<div class="game-link"><a href='?link=zadania'>Zadania</a><br></div>
	...
	<div class='content'>
					...
					include_once ('system/funkcje.php');
	...
	<div class="right">
		...
		echo '<progress id="file" value="'.$energia.'" max="100"></progress>'
		
		?>
		
		<form action="silnik/bar_funkcje/reset.php" method="post">
